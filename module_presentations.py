  ...
  ("character_language", prsntf_manual_end_only, 0,
   [(ti_on_presentation_load,
     [(set_fixed_point_multiplier, 1000),
      ...
      #player_character_language_french

      (create_button_overlay, reg0, "str_character_language_french"),
      (assign, "$g_presentation_obj_character_language_french", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (assign, "$g_presentation_obj_character_language_english", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (create_button_overlay, reg0, "str_character_language_german"),
      (assign, "$g_presentation_obj_character_language_german", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (assign, "$g_presentation_obj_character_language_russian", reg0),
      (overlay_set_color, reg0, 0xFFFFFF),
      (overlay_set_size, reg0, pos2),
      (position_set_y, pos1, ":cur_y"),
      (overlay_set_position, reg0, pos1),
      ...
      (ti_on_presentation_event_state_change,
        [(store_trigger_param_1, ":object"),
          (try_begin),
            (eq, ":object", "$g_presentation_obj_character_language_french"),
            (assign, reg5, player_character_language_french),
          (else_try),
            (eq, ":object", "$g_presentation_obj_character_language_english"),
            (assign, reg5, player_character_language_english),
          (else_try),
            (eq, ":object", "$g_presentation_obj_character_language_german"),
            (assign, reg5, player_character_language_german),
          (else_try),
            (eq, ":object", "$g_presentation_obj_character_language_russian"),
            (assign, reg5, player_character_language_russian),
          (try_end),
      #(gt, ":action", -1),
      (presentation_set_duration, 0),]),
    (ti_on_presentation_run,
