...
presentations = [("character_language", prsntf_manual_end_only, 0,
    ...
    (ti_on_presentation_event_state_change,
     [(store_trigger_param_1, ":object"),
      (try_begin),
        ...
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_french),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_english"),
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_english),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_prussian"),
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_prussian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_austrian"),
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_austrian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_russian"),
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_russian),
      (else_try),
        (eq, ":object", "$g_presentation_obj_language_pirate"),
        (multiplayer_send_int_to_server, client_event_change_character_language, player_character_language_pirate),
      (try_end),
