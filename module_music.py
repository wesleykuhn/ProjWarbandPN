...
tracks = [
 ...
 ("fight_1", "bizet_carmen_toreador.ogg", mtf_sit_fight, mtf_sit_siege|mtf_sit_ambushed),
 ...
 ("lords_hall_rhodok", "the_great_hall.ogg", mtf_culture_3|mtf_sit_tavern, mtf_culture_all|mtf_sit_town|mtf_sit_travel),
 ("lords_hall_vaegir", "boccherini_minuet.ogg", mtf_culture_3|mtf_sit_tavern, mtf_culture_all|mtf_sit_town|mtf_sit_travel),
 ("mounted_snow_terrain_calm", "grieg_peer_gynt_in_the_hall_of_the_mountain_king.ogg", mtf_sit_travel, mtf_sit_night|mtf_sit_town|mtf_sit_tavern),
 ...
 ("tavern_1", "strauss_blue_danube_waltz.ogg", mtf_sit_tavern, mtf_sit_town|mtf_sit_travel),
 ...
 ("uncertain_homestead", "bizet_carmen_overture.ogg", mtf_culture_1|mtf_culture_2|mtf_sit_travel, mtf_culture_all|mtf_sit_tavern|mtf_sit_town),
