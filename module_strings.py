...
"),
 ...
 # ("drum_prussia_2","Dessauer Marsch"),
  ...
  ("cannot_use_cannon", "You are not an Artillerist and cannot use cannons!"),
  ("cannot_use_rocket", "You are not an Artillerist and cannot use rockets!"),
