...
scene_props = [
  ...
  ("pn_buy_key", spr_buy_item_flags(3), "key", "bo_pw_weapon_small", spr_buy_item_triggers  ("itm_key", resources=["itm_iron_piece"], engineer=1)),
  ("pn_buy_key_gold", spr_buy_item_flags(3), "key_gold", "bo_pw_weapon_small", spr_buy_item_triggers  ("itm_key_gold", resources=["itm_copper_piece"], engineer=1)),
  ...
  # ARTY TRAIN
  ("pn_buy_arty_horse_cannon_french", spr_buy_item_flags(60), "french_carabineer_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_cannon_french", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_cannon_british", spr_buy_item_flags(60), "british_iniskilling_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_cannon_british", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_cannon_russian", spr_buy_item_flags(60), "russian_dragoon_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_cannon_russian", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_cannon_austrian", spr_buy_item_flags(60), "austrian_hussard_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_cannon_austrian", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_cannon_prussian", spr_buy_item_flags(60), "prussian_cuirassier_horse1", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_cannon_prussian", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_howitzer_french", spr_buy_item_flags(60), "french_carabineer_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_howitzer_french", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_howitzer_british", spr_buy_item_flags(60), "british_iniskilling_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_howitzer_british", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_howitzer_russian", spr_buy_item_flags(60), "russian_dragoon_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_howitzer_russian", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_howitzer_austrian", spr_buy_item_flags(60), "austrian_hussard_horse", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_howitzer_austrian", resources=[("itm_copper_bar_long",4)], engineer=7)),
  ("pn_buy_arty_horse_howitzer_prussian", spr_buy_item_flags(60), "prussian_cuirassier_horse1", "bo_pw_horse", spr_buy_item_triggers("itm_arty_horse_howitzer_prussian", resources=[("itm_copper_bar_long",4)], engineer=7)),
