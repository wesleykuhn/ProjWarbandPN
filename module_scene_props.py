...
scene_props = [
  ...
  ("pn_ship_cannon_attachment", 0, "pn_cannon_attach_indicator", "0", []),
  ...
  ("pn_buy_neutral_old_pistol_1766", spr_buy_item_flags(8), "french_pistol_1766", "bo_pw_weapon_small", spr_buy_item_triggers("itm_neutral_old_pistol_1766", resources=["itm_iron_bar_short", "itm_iron_piece", "itm_stick"], engineer=5)),
  ...
  ("pn_buy_neutral_lance", spr_buy_item_flags(5), "saxon_ulan_pike", "bo_pw_weapon_big", spr_buy_item_triggers  ("itm_neutral_lance", resources=["itm_iron_piece", "itm_wood_pole"], engineer=5)),
  ...
  ("pn_buy_rus_partisan_hat1", spr_buy_item_flags(4), "rus_random_hat", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_rus_partisan_hat1", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_rus_partisan_hat2", spr_buy_item_flags(4), "rus_random_hat1", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_rus_partisan_hat2", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_rus_partisan_hat3", spr_buy_item_flags(4), "partizan_hat_1", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_rus_partisan_hat3", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_rus_partisan_hat4", spr_buy_item_flags(4), "partizan_hat_2", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_rus_partisan_hat4", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_rus_partisan_hat5", spr_buy_item_flags(4), "partizan_hat_3", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_rus_partisan_hat5", resources=["itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_rus_chevgarde_gloves", spr_buy_item_flags(2), "mm_invisible_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_rus_chevgarde_gloves", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_fr_cuirassier_gloves", spr_buy_item_flags(2), "fr_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_fr_cuirassier_gloves", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_fr_artillery_gloves", spr_buy_item_flags(2), "glove_black_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_fr_artillery_gloves", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_br_cavalry_gloves", spr_buy_item_flags(2), "white_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_br_cavalry_gloves", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_br_horseguard_gloves", spr_buy_item_flags(2), "hg_cavalry_glove_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_br_horseguard_gloves", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_br_cavalry_gloves_short", spr_buy_item_flags(2), "white_cavalry_glove_short_L", "bo_pw_armor_hand", spr_buy_item_triggers  ("itm_br_cavalry_gloves_short", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_br_horseguard_gloves_short", spr_buy_item_flags(2), "hg_cavalry_glove_short_L", "bo_pw_armor_hand", spr_buy_item_triggers("itm_br_horseguard_gloves_short", resources=["itm_linen_cloth"], tailoring=2)),
  ...
  ("pn_buy_cuirassier_horse_french_officer", spr_buy_item_flags(12), "french_cuirassier_officer_horse", "bo_pw_horse", spr_buy_item_triggers  ("itm_cuirassier_horse_french_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_carabineer_horse_french_officer", spr_buy_item_flags(12), "french_carabineer_officer_horse", "bo_pw_horse", spr_buy_item_triggers  ("itm_carabineer_horse_french_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_lightdragoon_horse_britain_1", spr_buy_item_flags(12), "british_ld_horse1", "bo_pw_horse", spr_buy_item_triggers  ("itm_lightdragoon_horse_britain_1", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pn_buy_lightdragoon_horse_britain_3", spr_buy_item_flags(12), "british_ld_horse3", "bo_pw_horse", spr_buy_item_triggers  ("itm_lightdragoon_horse_britain_3", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_lancer_horse_prussia_1", spr_buy_item_flags(12), "prussian_cuirassier_horse1", "bo_pw_horse", spr_buy_item_triggers  ("itm_lancer_horse_prussia_1", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pn_buy_hussar_horse_prussia_1", spr_buy_item_flags(12), "prussian_cuirassier_horse1", "bo_pw_horse", spr_buy_item_triggers  ("itm_hussar_horse_prussia_1", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pn_buy_dragoon_horse_prussia_1", spr_buy_item_flags(12), "prussian_dragoon_horse", "bo_pw_horse", spr_buy_item_triggers  ("itm_dragoon_horse_prussia_1", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pn_buy_heavy_horse_prussia_1", spr_buy_item_flags(12), "prussian_cuirassier_horse1", "bo_pw_horse", spr_buy_item_triggers  ("itm_heavy_horse_prussia_1", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ("pn_buy_cossack_horse_russia_4", spr_buy_item_flags(12), "russian_cossack_horse4", "bo_pw_horse", spr_buy_item_triggers  ("itm_cossack_horse_russia_4", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_lancer_horse_rhine_officer", spr_buy_item_flags(12), "saxon_ulan_horse_white", "bo_pw_horse", spr_buy_item_triggers  ("itm_lancer_horse_rhine_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_hussar_horse_rhine_officer", spr_buy_item_flags(12), "nassau_horse_off", "bo_pw_horse", spr_buy_item_triggers  ("itm_hussar_horse_rhine_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_cuirassier_horse_rhine_officer", spr_buy_item_flags(12), "westphalian_cuirassier_horse_off", "bo_pw_horse", spr_buy_item_triggers  ("itm_cuirassier_horse_rhine_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
  ...
  ("pn_buy_garde_du_corps_horse_rhine_officer", spr_buy_item_flags(12), "garde_du_corps_horse_off", "bo_pw_horse", spr_buy_item_triggers("itm_garde_du_corps_horse_rhine_officer", resources=["itm_saddle", "itm_wheat_sheaf"], herding=1)),
