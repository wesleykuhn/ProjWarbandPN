...
scene_props = [
  ...
  ("pn_buy_peasant_hat", spr_buy_item_flags(4), "rus_random_hat", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_peasant_hat", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_militia_hat", spr_buy_item_flags(4), "rus_random_hat1", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_militia_hat", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_top_hat", spr_buy_item_flags(4), "partizan_hat_1", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_top_hat", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_peasant_hat2", spr_buy_item_flags(4), "partizan_hat_2", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_peasant_hat2", resources=["itm_linen_cloth"], tailoring=2)),
  ("pn_buy_peasant_hat3", spr_buy_item_flags(4), "partizan_hat_3", "bo_pw_armor_head", spr_buy_item_triggers  ("itm_peasant_hat3", resources=["itm_linen_cloth"], tailoring=2)),
